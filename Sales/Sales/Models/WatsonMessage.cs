...
namespace Sales.Models
{
    ...
    public partial class WatsonMessage
    {
        public static WatsonMessage FromJson(string json) => JsonConvert.DeserializeObject<WatsonMessage>(json, Sales.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WatsonMessage self) => JsonConvert.SerializeObject(self, Sales.Models.Converter.Settings);
    }
